...
\begin{tcolorbox}[colback=accentlight, colframe=accentdark]
\textbf{核心技巧汇总：}
\begin{itemize}[leftmargin=2em, itemsep=0.3em]
    \item \textbf{概率论：}补集法、指示随机变量、期望的线性性
    \item \textbf{递推思维：}将复杂问题转化为递推关系
    \item \textbf{图论建模：}De Bruijn序列、欧拉回路
    \item \textbf{优化策略：}两阶段策略、角速度匹配
    \item \textbf{算法复杂度：}快排特性、DP状态设计
\end{itemize}
\end{tcolorbox}
